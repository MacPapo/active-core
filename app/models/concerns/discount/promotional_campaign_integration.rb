module Discount::PromotionalCampaignIntegration
  ...
  def promotional_message
    ...
    def promotional_message
      ...
      base_message = I18n.t("discounts.promotional.base_message",
                            discount_description: discount_description,
                            service_type: applies_to_service_type.downcase
                           )

      I18n.t("discounts.promotional.urgency.#{urgency}", message: base_message)
    end
    # OLD
    # urgency = campaign_urgency
